...
const index = ({ navigation }) => {
        ...
        if (validatePhoneNumber()) {
            firebase.auth().signInWithPhoneNumber(phoneNo)
                .then(val => {
                    ...
                    navigation.navigate('LoginVerification',{confirmResult:val,phoneNo,fname,lname,email,password,gender})
    ...
    const userCheck = () => {
        ...
        setloaded(true)
        if(fname && lname && phoneNo && email && password && gender){
        ...
        <ImageBackground style={styles.container} source={backgroundImage}>
            ...
            <ScrollView style={{ flex: 1 }}>
                ...
                <View style={styles.contentView}>
                    ...
                    <TextInput
                        placeholder='(Country code **********) رقم الجوال'
                        placeholderTextColor='#fff'
                    ...
                    <View style={styles.signinBtnView}>
                        <Pressable onPress={() => alert('سجل دخول')} >
